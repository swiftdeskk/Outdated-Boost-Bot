...
func PrintASCII() {
	color.Println()
	color.Println()
	color.Println(`<fg=ff42b3>                 _________    __    ___   _  ____  __   __  ___   _______    ____________  _____ ______</><fg=ff42b3></>`)
	color.Println(`<fg=e535c2>                / ____/   |  / /   /   | | |/ /\ \/ /  / / / / | / /  _/ |  / / ____/ __ \/ ___// ____/</><fg=e535c2></>`)
	color.Println(`<fg=cc29d0>               / / __/ /| | / /   / /| | |   /  \  /  / / / /  |/ // / | | / / __/ / /_/ /\__ \/ __/   </><fg=cc29d0></>`)
	color.Println(`<fg=9910ed>              / /_/ / ___ |/ /___/ ___ |/   |   / /  / /_/ / /|  // /  | |/ / /___/ _, _/___/ / /___   </><fg=9910ed></>`)
	color.Println(`<fg=7f03fc>              \____/_/  |_/_____/_/  |_/_/|_|  /_/   \____/_/ |_/___/  |___/_____/_/ |_|/____/_____/  </><fg=7f03fc></>`)
	color.Println()
	color.Println()
}
